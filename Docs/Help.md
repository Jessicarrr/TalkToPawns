...
This prompt helps local models using Koboldcpp generate more meaningful conversation memories. Feel free to use or modify this prompt in your "Prompt for AI to create memories" option in the mod settings menu.
...
This prompt leverages the AI's text completion abilities to elicit a more precise response, improving the quality of conversation memories generated by the mod. If you keep the default setting the mod provides, you may end up with non committal responses like "neutral conversation".
